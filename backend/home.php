                ...
                <ul class="navbar-nav gap-4 ms-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../frontend/income.html">Add Income</a></li>
                            <li><a class="dropdown-item" href="../frontend/addTransactions.html">Add Transactions</a></li>
                            <li><a class="dropdown-item" href="../frontend/saving.html">Savings Goals</a></li>
                            <li><a class="dropdown-item" href="../frontend/report.html">Reports</a></li>
                        </ul>
                    </li>
                </ul>
